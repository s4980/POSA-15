...
public abstract class LifecycleLoggingActivity extends Activity {
    ...
    protected void onStart(){
    	...
    	Log.d(TAG, "onStart(): activity started now");
    }
    ...
    protected void onResume(){
    	...
    	Log.d(TAG, "onResume(): activity resumed now");
    }
    ...
    protected void onPause(){
    	...
    	Log.d(TAG, "onPause(): activity paused now");
    }
    ...
    protected void onStop(){
    	...
    	Log.d(TAG, "onStop(): activity stop now");
    }
    ...
    protected void onRestart(){
    	...
    	Log.d(TAG, "onRestart(): activity restarted now");
    }
    ...
    protected void onDestroy(){
    	...
    	Log.d(TAG, "onDestroy(): activity destroyed now");
    }
}
